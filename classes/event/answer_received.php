...
/**
 * The block_openai_chat issue created event.
 *
...
namespace block_openai_chat\event;

defined('MOODLE_INTERNAL') || die();

class answer_received extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('answerreceived', 'block_openai_chat');
    }
